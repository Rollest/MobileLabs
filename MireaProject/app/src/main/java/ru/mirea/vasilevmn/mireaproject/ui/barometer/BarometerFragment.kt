...
class BarometerFragment : Fragment(), SensorEventListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view = inflater.inflate(R.layout.fragment_barometer, container, false)

        textViewBarometer = view.findViewById(R.id.textViewBarometer)
